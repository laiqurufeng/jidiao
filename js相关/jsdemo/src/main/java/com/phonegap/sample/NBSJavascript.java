...
//		Mint.transactionCancel(name, reason, extraData);
	...
	public void logView(String currentView, String loadTime, String domainLookupTime, String serverTime,
		...
		CustomLog.d("currentView:"+currentView+",loadTimeInt:"+loadTimeInt+",domainLookupTime:"+domainLookupTime+",serverTimeInt:"+serverTimeInt+",domProcessingTimeInt:"+domProcessingTimeInt
				+",extraData:",extraData);
